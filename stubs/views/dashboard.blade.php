 ...
 <body class="bg-gray-100 p-6">
     ...
     <div class="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
         <div class="bg-white rounded-2xl shadow p-6 flex flex-col space-y-2">
             ...
             <div class="mt-4 flex flex-col p-4 rounded-lg items-center justify-center" x-data="timerComponent(@js($startTime))"
         ...
         <div class="bg-white rounded-2xl shadow p-6 h-full"
             style="max-height: 358px; overflow: hidden; overflow-y: scroll;" x-data="{}"
